...
5. 优先覆盖这些指标：
   ...
   - 盈利能力：毛利率、净利率、净资产收益率、资产回报率、调整后利润（重要：港股公司必须重点识别“非国际报告准则利润”或“经调整利润”，这是衡量经营质量的核心指标；A股优先扣非归母净利润）
...
2. 尤其关注这些内容是否在当前块中出现：收入分业务/分区域、利润变化原因、费用结构、现金流、资产负债、研发投入、战略方向、风险提示、调整后利润（重要：港股务必重点寻找“非国际报告准则利润”及其剔除项，A股寻找扣非口径）。
...
1. **财报概况**
   ...
   - **营业总收入**：__
   - **净利润**：__
   - **调整后利润**：__（对于港股，重点展示“非国际报告准则利润”；A股展示扣非归母净利润）
   - **调整后利润与法定利润差异**：__
   - **调整后利润差异原因**：__
   - **每股收益（EPS）**：__
   - **毛利率**：__
